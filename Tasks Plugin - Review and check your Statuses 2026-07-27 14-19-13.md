...
38["'fire'<br>[f] -> [x]<br>(TODO)"]:::TODO
39["'key'<br>[k] -> [x]<br>(TODO)"]:::TODO
40["'win'<br>[w] -> [x]<br>(TODO)"]:::TODO
41["'up'<br>[u] -> [x]<br>(TODO)"]:::TODO
42["'down'<br>[d] -> [x]<br>(TODO)"]:::TODO
1 --> 2
2 --> 1
3 --> 2
4 --> 1
...
- [R] Sample task 29: status symbol=`R` status name='review'
- [+] Sample task 30: status symbol=`+` status name='Inbox / task that should be processed later'
- [B] Sample task 31: status symbol=`B` status name='brainstorm'
- [D] Sample task 32: status symbol=`D` status name='deferred or scheduled'
- [N] Sample task 33: status symbol=`N` status name='note'
- [Q] Sample task 34: status symbol=`Q` status name='quote'
- [W] Sample task 35: status symbol=`W` status name='win / success / reward'
- [P] Sample task 36: status symbol=`P` status name='pro'
- [C] Sample task 37: status symbol=`C` status name='con'
- [f] Sample task 38: status symbol=`f` status name='fire'
- [k] Sample task 39: status symbol=`k` status name='key'
- [w] Sample task 40: status symbol=`w` status name='win'
- [u] Sample task 41: status symbol=`u` status name='up'
- [d] Sample task 42: status symbol=`d` status name='down'
